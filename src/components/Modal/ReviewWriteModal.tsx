...
export default function ReviewWriteModal() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (formData.star <= 0 || formData.star > 5)
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <textarea
          className="h-24 w-full resize-none rounded-md border-2 border-gray-medium p-3 outline-none focus-visible:border-secondary"
          name="content"
          id="content"
